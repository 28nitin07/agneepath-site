    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-orange-50">
        ...
        >
          {stats.map((stat, index) => (
            <motion.div key={stat.label} variants={item}>
              <Card className="group relative overflow-hidden border-2 border-gray-200 hover:border-orange-400 hover:shadow-xl hover:shadow-orange-200/50 transition-all duration-300">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 pb-20">
        ...
        >
          ...
          <Card className="group relative overflow-hidden border-2 border-gray-200 shadow-2xl shadow-orange-200/50">
